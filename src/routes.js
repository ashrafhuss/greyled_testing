...
const ProfessorSignup = lazy(()=>import('./Pages/professorSignup'))
const ProfessorSignin = lazy(()=>import('./Pages/professorSingin'))
...
const AssignDefaultBook = lazy(()=>import('./Pages/assignDefaultBook'))
const AssignSingleBook = lazy(()=>import('./Pages/assignSignleBook'))
...
export const routes = [
  ...
  },
  {
    authGuard: true,
    path: "/defaultBook",
    component: AssignDefaultBook,
    exact: true,
  },
  {
    authGuard: true,
    path: "/singleBook",
    component: AssignSingleBook,
    exact: true,
  },
];